...
class SimpleCollectionTest {
     ...
     * что можно выбрать один элемент
     * из коллекции и дальше проверять только его.
     */
    @Test
    ...
    /**Этот метод показывает,
     * как можно выбрать из коллекции группу
     * элементов по некоторому условию
    ...
    /**Библиотека AssertJ может работать с коллекциями,
     *  реализующими интерфейс java.util.Map.
     */
    @Test
    void assertMap() {
